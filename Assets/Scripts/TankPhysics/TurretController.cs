...
public class TurretController : MonoBehaviour
{
    ...
    public void SetCamTransform(Transform cameraTransform) { if (cameraTransform == null) return; _cameraTransform = cameraTransform; }
    ...
    private void HandleRotation()
    {
        ...
        else { _currentSpeed = 0f; _currentLocalAngle = targetAngle; }
        ApplyRotation();
    }
